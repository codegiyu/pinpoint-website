      ...
      <div className="hero-content w-full-h-full absolute inset-0 pinpoint-container touch-events-none z-30">
        <div className="w-full h-full justify-center lg:justify-between flex-col  flex gap-12 md:gap-16 lg:gap-0  lg:flex-row place-items-center mt-12 md:mt-4 lg:mt-0 relative ">
          <div className="w-full lg:w-3/7 grid gap-2 ">
            ...
            <p className="bottom-[3.125rem] md:bottom-0 left-0 w-full lg:pt-0 text-[1.15rem] typo-body-3 md:typo-body-1 md:text-[1.4rem] leading-6.5 md:leading-normal break-words text-wrap">
              Transform your ideas into reality with our creative communication agency in Brussels.
            </p>
            <p className="bottom-[3.125rem] md:bottom-0 left-0  w-fit md:w-4/5  lg:pt-0 text-sm  typo-body-2 md:text-base md:typo-subtitle leading-6 md:tracking-wide md:leading-7 break-words text-wrap">
