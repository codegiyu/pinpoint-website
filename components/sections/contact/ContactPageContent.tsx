...
export default function ContactPageContent() {
  return (
    <section className="w-full h-screen relative inset-0 pb-4 text-white bg-amber-500">
      <video
        src="/videos/contact-animation.webm"
        className="w-full min-h-[105vh] md:min-h-screen relative inset-0 object-cover"
        autoPlay
        loop
        muted
        playsInline
      />
      <div className="overlay bg-[#00000022] inset-0 z-10 absolute min-h-[105vh] md:min-h-screen w-screen"></div>
